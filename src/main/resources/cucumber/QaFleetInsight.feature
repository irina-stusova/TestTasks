...
#  Scenario: I open the FleetInsight Login Page and check activity of the links in the Contact Info section of the Footer
#    When I open url "https://qa.fleetinsight.com"
#    And I click the Contact Us link
#    Then I get the page opened in a new browser window and check correctness of the url "https://qa.fleetinsight.com/fiportal/public/contact-us"
...
#    Then I get the page opened in a new browser window and check correctness of the url "https://www.gopenske.com/newsroom/"
  ...
  Scenario: I open the FleetInsight Login Page, check correctness of the copyright year and check activity of the links in the bottom section of the Footer
    ...
    Then I get the page opened in a new browser window and check correctness of the url "https://qa.fleetinsight.com/fiportal/public/policy"
    And I click the Terms and Conditions link
    Then I get the page opened in a new browser window and check correctness of the url "https://qa.fleetinsight.com/fiportal/public/terms-of-use"