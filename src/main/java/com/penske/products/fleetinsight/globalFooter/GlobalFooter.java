package com.penske.products.fleetinsight.globalFooter;
...
public class GlobalFooter {
    ...
    private static final String LABEL_SUPPORT_PHONE_HREF = "//footer//section//h2[@class='site-footer__247-info--subheader']";
